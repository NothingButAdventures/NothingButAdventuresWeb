    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="w-full bg-white border-b">
        <div className="max-w-full mx-auto px-4 md:px-12 lg:px-24 py-4 md:py-6">
          <div className="text-[13px] text-gray-500 mb-4">
            <Link href="/admin" className="hover:text-[#4C1D95]">Admin</Link> / <Link href="/admin/tours-management" className="hover:text-[#4C1D95]">Tours</Link> / Create New Tour
          </div>
          <h1 className="text-3xl md:text-4xl font-semibold text-[#4C1D95] mb-2">Create New Tour</h1>
          <div className="text-gray-500 text-sm">Fill in the details step by step to publish a new tour</div>
        </div>
      </div>
      ...
      <div className="max-w-full mx-auto px-4 md:px-12 lg:px-24 py-8">
        <form onSubmit={handleSubmit}>
                ...
                <div className="md:col-span-2 flex gap-6">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-4 h-4 text-[#3F3F42] border-gray-300 rounded focus:ring-gray-900"
                    />
                    <label className="ml-2 text-sm text-[#3F3F42]">Active</label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="w-4 h-4 text-[#3F3F42] border-gray-300 rounded focus:ring-gray-900"
                    />
                    <label className="ml-2 text-sm text-[#3F3F42]">
                      Featured
                    </label>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border p-8 text-center">
            <h3 className="text-lg font-semibold text-[#3F3F42] mb-2">Ready to Publish?</h3>
            <p className="text-sm text-gray-500 mb-6">Review all steps before creating the tour. You can click on any step above to go back.</p>
            <button
              type="submit"
              disabled={submitting}
