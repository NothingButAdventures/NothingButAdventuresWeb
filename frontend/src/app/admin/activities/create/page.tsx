      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="max-w-3xl mx-auto px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-zinc-800">Create Activity</h1>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-md border border-gray-200 shadow-sm p-8 space-y-6">
          ...
          <div>
            ...
            <div 
              ...
              className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 rounded-md hover:bg-gray-50 transition-colors cursor-pointer relative overflow-hidden group min-h-[140px] items-center bg-gray-50/30 shadow-inner"
            >
              {formData.coverImage ? (
