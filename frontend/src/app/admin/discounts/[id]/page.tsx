...
export default function EditDiscountPage() {
    ...
    const uploadImageToSupabase = async (file: File): Promise<string | null> => {
        try {
            ...
            const fileName = `discount-${id}-${Date.now()}.${fileExt}`;
    ...
    if (loading) return <div className="p-10 flex justify-center text-gray-500 animate-pulse">Loading discount...</div>;
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <Link href="/admin/discounts" className="p-2 hover:bg-gray-100 rounded-full transition text-gray-500">
