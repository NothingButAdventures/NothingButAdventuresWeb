            ...
            const popup = L.popup({
                ...
                <div style="font-family:'Outfit',sans-serif;overflow:hidden;border-radius:8px;">
                    ...
                    <div style="padding:8px 10px;">
                        ...
                        ${m.tour ? `<a href="/tours/${m.tour.slug}" style="display:block;background:#111;color:white;text-align:center;padding:5px 8px;border-radius:5px;font-size:10px;font-weight:600;text-decoration:none;">View Tour →</a>` : ""}
                    </div>
                </div>
            `);
