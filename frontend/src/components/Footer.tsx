...
export default function Footer() {
    ...
    return (
        <footer className="w-full font-outfit">
            ...
            <div className="hidden md:block px-4 pt-10 pb-2">
                {/* Dark Curved Image Card Footer */}
                <div className="relative rounded-xl overflow-hidden text-white p-8 sm:p-12 lg:p-16 mb-1 shadow-md bg-[#1A1A1A]">
                    ...
                    <div className="absolute -left-8 -bottom-10 w-[320px] h-[320px] sm:w-[380px] sm:h-[380px] pointer-events-none opacity-20 z-0 overflow-hidden select-none">
                        <img
                            src="/nba_logo1.svg"
                            alt=""
                            className="w-full h-full object-contain invert brightness-0"
                    ...
                    <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-start">
                        {/* Left Brand Column */}
                        <div className="col-span-1 lg:col-span-5 max-w-md relative z-10">
                            <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold text-white leading-tight tracking-tight font-outfit">
                                Nothing but<br />
                                Adventures.
                            </h2>
                            <div className="w-40 h-[2px] bg-white/80 my-5"></div>
                            <p className="text-sm sm:text-base text-white/80 font-normal leading-relaxed font-outfit mb-6 max-w-xs">
                                Curating authentic Indian experiences for discerning travelers since 2015.
                            </p>

                            {/* Social Media Circular Buttons */}
                            <div className="flex items-center gap-3">
                                <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xs transition-colors cursor-pointer" aria-label="Facebook">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                                </a>
                                <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xs transition-colors cursor-pointer" aria-label="Instagram">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
                                </a>
                                <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xs transition-colors cursor-pointer" aria-label="Instagram">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
                                </a>
                                <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xs transition-colors cursor-pointer" aria-label="Twitter">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                                </a>
                                <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xs transition-colors cursor-pointer" aria-label="YouTube">
                        ...
                        {/* Right Columns Grid */}
                        <div className="col-span-1 lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8 relative z-10">
                            {/* Destinations */}
                            <div>
                                <h3 className="font-semibold text-base text-white mb-4 font-outfit">Destinations</h3>
                                <ul className="space-y-2.5 text-sm text-white/80 font-normal font-outfit">
                                    <li><Link href="/trips?destination=rajasthan" className="hover:text-white transition-colors">Rajasthan</Link></li>
                                    <li><Link href="/trips?destination=kerala" className="hover:text-white transition-colors">Kerala</Link></li>
                                    <li><Link href="/trips?destination=himalayas" className="hover:text-white transition-colors">Himalayas</Link></li>
                                    <li><Link href="/trips?destination=golden-triangle" className="hover:text-white transition-colors">Golden Triangle</Link></li>
                            ...
                            {/* Company */}
                            <div>
                                <h3 className="font-semibold text-base text-white mb-4 font-outfit">Company</h3>
                                <ul className="space-y-2.5 text-sm text-white/80 font-normal font-outfit">
                                    <li><Link href="/about-us" className="hover:text-white transition-colors">About Us</Link></li>
                                    <li><Link href="/why-nba" className="hover:text-white transition-colors">Why Choose Us</Link></li>
                                    <li><Link href="/#reviews" className="hover:text-white transition-colors">Reviews</Link></li>
                                    ...
                                    <li><Link href="/tree-planting" className="hover:text-white transition-colors">Sustainability</Link></li>
                                    <li><Link href="/careers" className="hover:text-white transition-colors">Careers</Link></li>
                                    <li><Link href="/partner/affiliate" className="hover:text-white transition-colors">Become an Affiliate</Link></li>
                                </ul>
                            </div>

                            {/* Contact Us */}
                            <div>
                                <h3 className="font-semibold text-base text-white mb-4 font-outfit">Contact Us</h3>
                                <ul className="space-y-3.5 text-sm text-white/80 font-normal font-outfit">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#1A1A1A] font-outfit px-1 py-2">
