...
const reasons = [
    {
        icon: (
            <svg className="w-5 h-5 text-[#3F3F42]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <section className="mx-auto mt-24 mb-16">
            <div className="mb-10">
                ...
                <h2 className="text-[48px] md:text-[64px] font-medium leading-[1.1] text-[#3F3F42] mb-4">
                    Why Travel With Us
                </h2>
                <p className="text-[17px] md:text-[18px] text-[#3F3F42] font-semibold leading-[1.6]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {reasons.map((reason, index) => (
                    <div key={index} className="bg-[#f8f9fa] rounded-[20px] p-6 lg:p-8 flex flex-col h-full hover:shadow-sm transition-shadow">
                        ...
                        <h3 className="text-[18px] font-semibold text-[#3F3F42] mb-2 leading-tight">
                            {reason.title}
                        </h3>
                        <p className="text-[#3F3F42] text-[15px] leading-[1.6]">
                            {reason.description}
                        </p>
                    </div>
                ))}
            ...
            {/* Dark Stats Banner */}
            <div className="bg-[#3F3F42] text-white rounded-[20px] py-10 px-6 md:px-12 flex flex-col md:flex-row items-center justify-around gap-8 md:gap-4">
