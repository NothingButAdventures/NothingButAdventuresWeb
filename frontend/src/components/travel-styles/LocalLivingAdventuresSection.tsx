...
export default function LocalLivingAdventuresSection() {
  return (
    <section className="mt-10 md:mt-14">
      ...
      <h2 className="mt-4 text-[40px] font-semibold leading-tight text-[#3F3F42] md:text-[56px]">
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[360px_minmax(0,1fr)] lg:gap-10">
        ...
        <div className="rounded-[14px] bg-[#f1f3f6] p-7 md:p-10">
          <h3 className="text-[34px] font-semibold leading-tight text-[#3F3F42] md:text-[48px]">
            More than Just Sight Seeing
          </h3>
          <p className="mt-4 text-[14px] leading-relaxed text-[#3F3F42] md:text-[15px]">
