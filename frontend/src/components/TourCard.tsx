            ...
            <div className="flex flex-col bg-white rounded-[16px] border border-gray-200 shadow-sm overflow-hidden h-full transition-transform duration-300 hover:shadow-md">
                ...
                <div className="p-4 md:p-5 flex flex-col grow bg-white">
                    ...
                    <div className="flex justify-between items-start gap-4 mb-1">
                        <h3 className="text-[19px] md:text-[21px] font-bold text-black leading-tight flex-1 line-clamp-1">
                            {tour.name}
                        </h3>
                        <div className="text-[19px] md:text-[21px] font-bold text-black shrink-0">
                            ${Math.round(discountedPrice).toLocaleString()}
                        </div>
                    </div>

                    {/* Subtitle / Description */}
                    <p className="text-[14px] text-black line-clamp-1 mb-3">
                        {descriptionText}
                    </p>
                    ...
                    {/* Footer */}
                    <div className="flex justify-between items-center text-[13px] md:text-[14px] text-black">
                        <div className="flex items-center gap-1.5">
                            <svg className="w-[18px] h-[18px] text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
